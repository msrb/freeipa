...
def test_public_key_parsing():
    ...
    pks = [
        (b'\xff',                   UnicodeDecodeError if six.PY2 else ValueError),
        (u'\xff',                   ValueError),
        ...
        (b64,                       openssh),
        (unicode(b64),              openssh),
        (b64.encode('ascii'),       openssh if six.PY2 else ValueError),
        (u'\n%s\n\n' % b64,         openssh),
        ...
        (openssh.encode('ascii'),   openssh if six.PY2 else ValueError),
